...
export class UserController {
  ...
  async updateUserRole(request: FastifyRequest, reply: FastifyReply) {
    const session = await auth.api.getSession({
      headers: request.headers as any as any,
    })
  ...
  async getPublicProfile(request: FastifyRequest, reply: FastifyReply) {
    ...
    const loggedInUserShowOnline = session
      ? (session.user as any).showOnline !== false
      : false
    ...
    try {
      ...
      console.error(
        'Failed to sync Green Member status in getPublicProfile:',
        err,
      )
    }
    ...
    try {
      ...
      if (body.showOnline !== undefined) {
        try {
          ...
          console.error(
            'Failed to broadcast presence update after settings change:',
            err,
          )
        }
      }
      ...
      return reply
        .status(400)
        .send({ message: error.message || 'Failed to update settings' })
    }
  }
  ...
  async getCloudinaryConfig(request: FastifyRequest, reply: FastifyReply) {
    ...
    if (!isDashboardRole(role)) {
      return reply
        .status(403)
        .send({ message: 'Forbidden: Dashboard role required' })
    }
    ...
    try {
      ...
      return reply
        .status(400)
        .send({ message: error.message || 'Failed to get settings' })
    }
  }
  ...
  async saveCloudinaryConfig(request: FastifyRequest, reply: FastifyReply) {
    ...
    try {
      const config = await userService.saveCloudinaryConfig(
        session.user.id,
        request.body as any,
      )
      ...
      return reply
        .status(400)
        .send({ message: error.message || 'Failed to save settings' })
    }
  }
  ...
  async testCloudinaryConfig(request: FastifyRequest, reply: FastifyReply) {
    ...
    try {
      ...
      return reply
        .status(400)
        .send({ message: error.message || 'Failed to connect to Cloudinary' })
    }
  }
  ...
  async getSessions(request: FastifyRequest, reply: FastifyReply) {
    ...
    try {
      ...
      return reply
        .status(400)
        .send({ message: error.message || 'Failed to fetch sessions' })
    }
  }
  ...
  async revokeSession(request: FastifyRequest, reply: FastifyReply) {
    ...
    try {
      ...
      return reply
        .status(400)
        .send({ message: error.message || 'Failed to revoke session' })
    }
  }
  ...
  async renameSession(request: FastifyRequest, reply: FastifyReply) {
    ...
    try {
      ...
      return reply
        .status(400)
        .send({ message: error.message || 'Failed to rename device' })
    }
  }
  ...
  async getRecentSearches(request: FastifyRequest, reply: FastifyReply) {
    ...
    try {
      ...
      return reply
        .status(400)
        .send({ message: error.message || 'Failed to fetch searches' })
    }
  }
  ...
  async saveRecentSearch(request: FastifyRequest, reply: FastifyReply) {
    ...
    try {
      const searches = await userService.saveRecentSearch(
        session.user.id,
        query,
      )
      ...
      return reply
        .status(400)
        .send({ message: error.message || 'Failed to save search' })
    }
  }
  ...
  async deleteRecentSearch(request: FastifyRequest, reply: FastifyReply) {
    ...
    try {
      ...
      return reply
        .status(400)
        .send({ message: error.message || 'Failed to delete search' })
    }
  }
  ...
  async clearRecentSearches(request: FastifyRequest, reply: FastifyReply) {
    ...
    try {
      ...
      return reply
        .status(400)
        .send({ message: error.message || 'Failed to clear searches' })
    }
  }
}
