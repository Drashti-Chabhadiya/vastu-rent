...
function AccountProfileSettings() {
  return (
    <div className="p-4 md:p-6">
      <h1 className="text-2xl font-black text-gray-900 mb-2">Account Settings</h1>
      <p className="text-sm text-gray-500 mb-8">Manage your account security, notifications, and lister preferences.</p>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-red-50/50 border border-red-100 rounded-2xl p-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-red-500">Send a request to Super Admins to permanently purge your data.</p>
          </div>
