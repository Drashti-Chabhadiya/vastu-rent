      ...
      <div className="flex items-center gap-3 w-full sm:w-auto">
        <div ref={sortRef} className="relative flex-1 sm:flex-none">
          <Button
            ...
            className={`w-full h-11 pl-3.5 pr-3.5 rounded-2xl bg-card border shadow-sm text-sm font-bold flex items-center gap-2.5 sm:min-w-[180px] justify-between transition-all hover:bg-transparent ${
              isSortOpen
            ...
            <div className="absolute top-full mt-2 left-0 right-0 bg-card border border-border/30 rounded-2xl shadow-xl z-50 overflow-hidden py-1.5 animate-in fade-in slide-in-from-top-1 duration-150">
              {(
                ...
                <Button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-2.5 text-sm font-semibold transition-colors rounded-none text-left ${
                    sortBy === opt.value
        ...
        <div className="flex items-center gap-1 bg-card border border-border/30 shadow-sm p-1 rounded-2xl shrink-0">
          <Button
            variant="ghost"
