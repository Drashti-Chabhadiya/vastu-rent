                    ...
                    <div className="grid grid-cols-2 gap-8">
                      <div className="space-y-3">
                        <h4 className="font-bold text-gray-900 text-sm uppercase tracking-wider flex items-center gap-2">
                          <Calendar size={16} className="text-primary" /> Rental
                          Terms
                        </h4>
                      ...
                      <>
                        ...
                        <div className="pt-2 border-t border-brand/10 flex items-center justify-between text-sm text-gray-900 font-black">
                          ...
                          <span className="text-primary">
                            ₹
                            {(
                              totalPrice + (product.securityDeposit || 0)
                            ).toLocaleString()}
                          </span>
                        </div>
                      </>
              ...
              <div className="xl:col-span-5 space-y-6">
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm space-y-5">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-gray-900 text-sm">
                        {product.owner?.name || 'Verified Owner'}
                      </p>
                      <div className="flex items-center gap-1.5 mt-0.5">
                        <Star size={12} className="text-primary fill-brand" />
                        <span className="text-xs font-bold text-gray-900">
                          {product.owner?.rating || '0.0'}
                        </span>
                        <span className="text-xs text-gray-500">
                          ({product.owner?.listingsCount || 0} Listings)
                        </span>
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="flex items-center gap-2 text-gray-500 text-xs">
                      <MessageCircle size={14} className="shrink-0" /> Usually
                      responds in a few hours
                    </div>
                  </div>
                  <Link
                    to="/users/$id"
                    params={{ id: product.owner?.id || '' }}
                  >
                    <Button
                      variant="outline"
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm space-y-4">
                  ...
                  <div className="grid grid-cols-7 gap-y-1 gap-x-0.5 text-center">
                    {['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa'].map((d) => (
                      <div
                        key={d}
                        className="text-[10px] font-bold text-gray-400 py-1"
                      >
                        {d}
                      </div>
                    ))}
          ...
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl text-center space-y-5">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-2">
                {product.title || product.name} booked from{' '}
