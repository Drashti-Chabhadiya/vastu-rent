...
export function ListingsStatsRow({
  totalViews,
  totalBookings,
  totalEarnings,
  avgRatingValue,
}: ListingsStatsRowProps) {
  ...
  const stats = [
    ...
    },
    {
      ...
      trend: t('Excellent performance'),
      trendColor: 'text-muted-dark',
    },
  ]
        ...
        return (
          ...
          >
            ...
            <div>
              ...
              <p
                className={`text-[9px] font-extrabold flex items-center gap-0.5 mt-0.5 ${stat.trendColor}`}
              >
