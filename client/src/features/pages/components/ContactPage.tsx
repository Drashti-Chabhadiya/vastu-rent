              ...
              <form onSubmit={handleSendMessage} className="mt-10 space-y-6">
                ...
                <div className="pt-2">
                  <Button
                    type="submit"
                    disabled={isSubmitting}
                    className="group rounded-full bg-primary px-8 py-3.5 h-auto min-w-[180px] justify-center text-[14px] font-bold text-primary-foreground transition-all hover:bg-primary/95 active:scale-[0.98] cursor-pointer inline-flex items-center gap-3 [&_svg]:size-4"
                  >
                    {isSubmitting ? (
                      <>
                        {t('Sending')}
