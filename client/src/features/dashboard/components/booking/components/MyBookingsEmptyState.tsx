  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        'bg-card', 'rounded-[2.5rem]', 'border', 'border-dashed', 'border-border',
      )}
    >
      <div className={cn('w-16', 'h-16', 'bg-muted-light', 'rounded-full', 'flex', 'items-center', 'justify-center', 'mb-4')}>
      ...
      <p className={cn('text-muted-dark', 'text-xs', 'mt-1.5', 'max-w-xs', 'text-center', 'font-bold')}>
