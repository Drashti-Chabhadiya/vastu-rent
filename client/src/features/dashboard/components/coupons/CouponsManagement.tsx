          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
            <div>
              <h3 className="text-[15px] font-black text-[#1e293b]">
                All Active & Inactive Coupons
              </h3>
              <p className="text-[11px] font-bold text-slate-400">
                View and manage all coupons and discount offers.
              </p>
            </div>
        ...
        <div className="space-y-6">
          <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm relative overflow-hidden group">
            ...
            <p className="text-[11px] font-bold text-slate-400 mb-6 leading-relaxed">
              Apply a coupon code at checkout to reduce rental fee. Code must
          ...
          <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
            <h3 className="text-[15px] font-black text-[#1e293b] mb-6 uppercase tracking-widest">
              Helpful Tips
            </h3>
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <p className="text-[11px] font-bold text-slate-500">
                  Percentage type reduces rent by a relative amount.
                </p>
              </div>
              <div className="flex gap-3">
                <div className="w-5 h-5 rounded-full bg-emerald-50 flex items-center justify-center text-emerald-600 flex-shrink-0">
                ...
                <p className="text-[11px] font-bold text-slate-500">
                  Usage Limit bounds how many times customers can apply the
                  code.
                </p>
              </div>
            </div>
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            <p className="text-[13px] font-black text-[#1e293b]">
              Platform Guarantee & Integrity
            </p>
            <p className="text-[10px] font-bold text-slate-400">
              Coupon deductions are automatically adjusted in final landlord
              payout invoices.
            </p>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl max-w-md w-full p-8 border border-gray-100 shadow-2xl relative">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Create a voucher code to offer rental discounts on the
              marketplace.
            </p>
