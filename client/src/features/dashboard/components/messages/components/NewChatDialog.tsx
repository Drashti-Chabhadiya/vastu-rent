...
import { useSearchChatUsers, useCreateConversation, useIsMobile } from '#/hook'
        ...
        <DrawerContent className="max-h-[85vh] rounded-t-[2.5rem] border-none bg-card p-0 outline-none flex flex-col font-sans select-none">
          ...
          <div className="px-4 pt-4">
            <div className="relative">
              <Search
                size={13}
                className="absolute left-3 top-[13px] text-muted-dark"
              />
              <Input
                autoFocus
                ...
                className="h-10 pl-9 bg-muted-light border-none rounded-xl text-[11px] font-bold focus-visible:ring-1 focus-visible:ring-primary/20"
              />
            </div>
          </div>

          {/* Results list */}
          <div className="px-4 pb-6 mt-2 overflow-y-auto space-y-1 scrollbar-none flex-1 mb-6">
            {isSearchingUsers ? (
              ...
              userResults.map((u) => (
                <Button
                  ...
                  className="w-full flex items-center gap-3 p-3 rounded-2xl hover:bg-muted-light transition-colors cursor-pointer justify-start h-auto disabled:opacity-60"
                >
                  <UserAvatar
                    image={u.image}
                    name={u.name}
                  ...
                  {startingChatWith === u.id ? (
                    ...
                    <span className="text-[9px] font-black text-primary bg-primary-soft px-2 py-1 rounded-lg shrink-0">
                      {t('Chat')}
                    </span>
                  )}
                </Button>
