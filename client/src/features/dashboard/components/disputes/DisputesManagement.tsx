                ...
                {isLoading ? (
                  ...
                  disputes?.map((dispute) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-5 font-mono text-[10px] text-[#1e293b]">
                      ...
                      <td className="px-4 py-5 text-right">
                        <ChevronRight
                          size={14}
                          className="text-slate-300 group-hover:text-dash-brand transition-colors"
                        />
                      </td>
                    </tr>
                  ))
            ...
            <>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Badge className="bg-rose-50 text-rose-500 border-none px-2.5 py-0.5 text-[8px] font-black uppercase tracking-wider">
              ...
              {isAdmin && selectedDispute.status === 'open' && (
                <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-3">
                  <h3 className="text-[13px] font-black text-[#1e293b] mb-1 uppercase tracking-widest">
                    Dispute Actions
                  </h3>
                  <Button
                    onClick={() => {
